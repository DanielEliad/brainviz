...
import { ScaleType } from "./vis/drawFrame";
...
function App() {
    ...
    const [aggregation, setAggregation] = useState<"average" | "median">("average");
    ...
    const [method, setMethod] = useState<CorrelationMethod | null>("pearson");
    ...
    const [scaleType, setScaleType] = useState<ScaleType>("exponential");
