...
% Original version: D.Fellner, v1.13, Jul 31, 2008
% Previous version: EuroVis conference template by Dieter W. Fellner, Stefanie Behnke
% Adapted for VCBM 2026: E.Bones, 2026
% ---------------------------------------------------------------------------
...
% --- for VCBM 2026
%\WsSubmission    % uncomment for submission to VCBM
\WsPaper         % uncomment for final version of VCBM contribution
...
\title[VCBM 2026 \LaTeX\ Author Guidelines]%
      {\LaTeX\ Author Guidelines for VCBM 2026 Poster Manuscripts}

% For anonymous conference submission, please enter your SUBMISSION ID.
\author[Author 1 et al.]{Author 1 and Author 2}
...
%
% \volume{15}    % the volume in which the issue will be published;
...
submitting your manuscript to VCBM 2026.
...
\textbf{Please observe:} publications in the proceedings of 
Eurographics Workshops can typically use color images throughout the paper. 
